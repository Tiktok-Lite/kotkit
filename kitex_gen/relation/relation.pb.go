...
type RelationActionResponse struct {
	...
	StatusCode int32  `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"` //状态码，0代表成功，-1代表失败
	StatusMsg  string `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty"`     //返回状态信息
}
...
type RelationFollowListRequest struct {
	...
	Token  string `protobuf:"bytes,2,opt,name=token,proto3" json:"token,omitempty"`                  // 鉴权
}
...
func (x *RelationFriendListResponse) GetUserList() []*user.User {
	if x != nil {
		return x.UserList
	}
	return nil
...
type Friend struct {
	...
	Message         string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`                                        //和好友的聊天信息
	MsgType         int64  `protobuf:"varint,2,opt,name=msgType,proto3" json:"msgType,omitempty"`                                       //message消息的类型，0代表当前请求用户接收的消息， 1代表当前请求用户发送的消息
	...
	FollowCount     int64  `protobuf:"varint,5,opt,name=follow_count,json=followCount,proto3" json:"follow_count,omitempty"`            // 关注数
	FollowerCount   int64  `protobuf:"varint,6,opt,name=follower_count,json=followerCount,proto3" json:"follower_count,omitempty"`      // 粉丝数
	IsFollow        bool   `protobuf:"varint,7,opt,name=is_follow,json=isFollow,proto3" json:"is_follow,omitempty"`                     //是否关注，true-已关注，false-未关注
...
func (x *Friend) GetMsgType() int64 {
	if x != nil {
		return x.MsgType
	}
	return 0
...
func (x *Friend) GetFollowCount() int64 {
	if x != nil {
...
var file_idl_relation_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x6c, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6c,
	...
	0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x22, 0x4a, 0x0a, 0x19, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69,
	...
	0x65, 0x6e, 0x22, 0x85, 0x01, 0x0a, 0x1a, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x46,
	...
	0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x87, 0x01, 0x0a, 0x1c, 0x52, 0x65, 0x6c,
	...
	0x73, 0x74, 0x22, 0x4a, 0x0a, 0x19, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x72,
	...
	0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x97, 0x03, 0x0a, 0x06, 0x46, 0x72, 0x69, 0x65, 0x6e,
	...
	0x67, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x6c, 0x6f, 0x77, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x67, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x5f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x09, 0x20, 0x01,
	...
	,
	...
	0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x25, 0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x2e, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77,
...
var file_idl_relation_proto_depIdxs = []int32{
	...
	9, // 2: relation.RelationFriendListResponse.user_list:type_name -> user.User
