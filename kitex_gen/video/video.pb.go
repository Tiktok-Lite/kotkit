...
type PublicActionResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PublicActionResponse) Reset() {
	*x = PublicActionResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PublicActionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublicActionResponse) ProtoMessage() {}

func (x *PublicActionResponse) ProtoReflect() protoreflect.Message {
	mi := &file_idl_video_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PublicActionResponse.ProtoReflect.Descriptor instead.
func (*PublicActionResponse) Descriptor() ([]byte, []int) {
	return file_idl_video_proto_rawDescGZIP(), []int{5}
}

func (x *PublicActionResponse) GetStatusCode() int32 {
	if x != nil {
		return x.StatusCode
	}
	return 0
...
func (x *PublicActionResponse) GetStatusMsg() string {
	if x != nil {
		return x.StatusMsg
	}
	return ""
...
var file_idl_video_proto_rawDesc = []byte{
	...
	0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x56, 0x0a, 0x14, 0x50, 0x75,
	...
	0x6c, 0x65, 0x22, 0x56, 0x0a, 0x14, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x41, 0x63, 0x74, 0x69,
	...
	0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x22, 0xf6, 0x01, 0x0a, 0x05, 0x56,
	...
	0x74, 0x6c, 0x65, 0x32, 0xd6, 0x01, 0x0a, 0x0c, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x53, 0x65, 0x72,
	...
	0x4b, 0x0a, 0x0d, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x76, 0x69, 0x64, 0x65, 0x6f, 0x2e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x41, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x2f, 0x5a, 0x2d,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x54, 0x69, 0x6b, 0x74, 0x6f,
	0x6b, 0x2d, 0x4c, 0x69, 0x74, 0x65, 0x2f, 0x6b, 0x6f, 0x74, 0x6b, 0x69, 0x74, 0x2f, 0x6b, 0x69,
	0x74, 0x65, 0x78, 0x5f, 0x67, 0x65, 0x6e, 0x2f, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x62, 0x06, 0x70,
...
var file_idl_video_proto_goTypes = []interface{}{
	...
	(*PublicActionResponse)(nil), // 5: video.PublicActionResponse
...
var file_idl_video_proto_depIdxs = []int32{
	...
	4, // 5: video.VideoService.PublishAction:input_type -> video.PublishActionRequest
	1, // 6: video.VideoService.Feed:output_type -> video.FeedResponse
	3, // 7: video.VideoService.PublishList:output_type -> video.PublishListResponse
	5, // 8: video.VideoService.PublishAction:output_type -> video.PublicActionResponse
...
func file_idl_video_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_idl_video_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PublicActionResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type VideoService interface {
	...
	PublishAction(ctx context.Context, req *PublishActionRequest) (res *PublicActionResponse, err error)
}
